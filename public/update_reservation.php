...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_stmt_execute($stmt)) {
        ...
        header("Location: read_reservations.php?restaurant_id=" . $restaurant_id); // Use retrieved restaurant_id
        exit;
    } else {
...
<body>
    <div class="container">
        ...
        <form action="update_reservation.php?reservation_id=<?php echo $reservation_id; ?>&restaurant_id=<?php echo $_GET['restaurant_id']; ?>" method="POST">
